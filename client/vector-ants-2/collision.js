    ...
    if (c.entity === c_.entity) {
      ...
      return (function() {
        if (!(config.collisionStatic === 0)) {
          return c_v.accelerate([ (((Math.random() * (config.collisionStatic - 0)) + 0) * (function() {
            if (Math.random() < 0.5) {
              return -1;
            } else {
              return 1;
      ...
      return (function() {
        if (!(config.collisionStatic === 0)) {
          return cv.accelerate([ (((Math.random() * (config.collisionStatic - 0)) + 0) * (function() {
            if (Math.random() < 0.5) {
              return -1;
            } else {
              return 1;
      ...
      (function() {
        if (!(config.collisionStatic === 0)) {
          cv.accelerate([ (((Math.random() * (config.collisionStatic - 0)) + 0) * (function() {
            if (Math.random() < 0.5) {
              return -1;
            } else {
              return 1;
