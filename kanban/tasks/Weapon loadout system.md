...
I want my agents to have 3 types of weapons, a primary weapon, a side arm, and a melee/utility slot. By utility I mean like a knife, hatchet, hammer, etc.

A tool that could double as a melee weapon if it had to.

The primary and secondary weapons can be ranged weapons, or more combat specific melee weapons 
## Related Epics
