        ...
        if (this._center) {
          ...
          return this._center = (function() {
            ...
            if( this.members.length === 0 ){ 
              throw (new Error("can't calculate center of empty particle group."))
             };
...
var GrouperSystem = ParentSystem.define("GrouperSystem", { 
  ...
  bounds:[ minX, minY, maxX, maxY ]
 },[ positions, phys, groupIds, kdTree, barycenters ] ){ 
    ...
    const queryResults=kdTree.query(particle.x, particle.y, (particle.scale * 128));;
